function dy = NET_single(t, y,t_input1,I_input1,t_input2,I_input2)
...
dy(2) = -y(2) / 0.02 + c7 * (70 / (1 + exp(-(y(2) - 30) / 5)) + 0.1) ...
        ...
        + c2 * (70/ (1 + exp(-(y(1) - 30) / 5)) + 0.1);                                                      % Why input is divided by 0.1?
