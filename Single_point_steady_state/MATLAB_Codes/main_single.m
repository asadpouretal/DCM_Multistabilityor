...
tf=ts(end);
t0=ts(1);
X1=0.018*ones(n,length(ts)) / 0.1; %input 1
X2=0.012*ones(n,length(ts)) / 0.1; %input 2
...
%%%%%%%%%%%%%%%plot input%%%%%%%%%%%%%%%%%%
figure
plot(X1) % input to column 1
hold on 
plot(X2) % input to column 2
%%%%%%%%%%%%%%%plot output%%%%%%%%%%%%%%%%%%
figure
plot(LFP(1,:)) % Output of column 1
hold on 
plot(LFP1(1,:)) % Output of column 2
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
figure,
ch=squeeze(yg(1,:,2));
ch1=squeeze(yg(1,:,3));
