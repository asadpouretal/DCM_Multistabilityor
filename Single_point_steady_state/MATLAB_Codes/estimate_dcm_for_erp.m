function estimate_dcm_for_erp(data_struct, fs, main_folder, response_type, DT)
...
%     mkdir(save_folder);    
    ...
    if filesep == '/'
        ...
        % Define the specific trial indices you want to process
        trial_indices = 1:num_trials;
        
        % Use parfor to iterate over the indices of trial_indices
