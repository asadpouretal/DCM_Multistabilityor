function estimate_dcm_for_erp(data_struct, fs, main_folder, response_type, evidence_quality, DT)
    ...
    save_folder = fullfile(main_folder, 'test', response_type, num2str(evidence_quality));
...
function process_trial(i, data_struct, time_vector, DT, fs, main_folder, save_folder)
    ...
    models = {'lateral', 'forward_backward'};
