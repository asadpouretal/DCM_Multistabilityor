...
switch filesep
    ...
    case '/'
        ...
        numWorkers = 50;  % Adjust this number based on your hardware capabilities
...
evidence_quality_number = 5;    % evidence quality number

% Call the function with the dynamically accessed variable
estimate_dcm_for_erp(variable_to_pass{evidence_quality_number}, fs, main_folder, response_type, a_values(evidence_quality_number), down_sample);
