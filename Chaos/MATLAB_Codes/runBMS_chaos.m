...
switch filesep
    case '\'
        ...
        main_folder = 'D:\Data\DCM validation\chaos_csd';
    ...
    case '/'
        ...
        main_folder = '/mnt/scratch2/users/aasadpour/DCM validation/chaos';
...
try
    ...
    outputFolder = fullfile(main_folder, 'BMS', 'combined');
    ...
    % performPEBGroupLevel(dataFolder, modelName, outputFolder);
    performDCMPEBAnalysis(dataFolder, modelNames, outputFolder);
