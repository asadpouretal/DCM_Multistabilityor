function dX = model3(X, idx, bump1, bump2, noise_amp, tampa, Ae, Ai, ae, ai, cL12, cL21, cLi12, cLi21, c1,c2,c3, c4, c5, c6, c7)
    n1 = bump1(idx);
    n2 = bump2(idx);
    ...
    dx1 = x8;
    dx8 = Ae * ae * (c1 * S(x2 - x3 + x7) + cL12 * S(x17 - x18 + x22) + I_eta1 + n1) - 2 * ae * x8 - ae ^ 2 * x1;
    dx2 = x9;
    dx9 = Ae * ae * (c2 * S(x1 + x6)) - 2 * ae * x9 - ae ^ 2 * x2;
    dx3 = x10;
    dx10 = Ai * ai * (c3 * S(x4 - x5)) - 2 * ai * x10 - ai ^ 2 * x3;
    dx4 = x11;
    dx11 = Ae * ae * (cLi12 * S(x17 - x18 + x22) + c4 * S(x2 - x3 + x7) + I_eta1 + n1) - 2 * ae * x11 - ae ^ 2 * x4;
    dx5 = x12;
    ...
    dx16 = x23;
    dx23 = Ae * ae * (c1 * S(x17 - x18 + x22) + cL21 * S(x2 - x3 + x7) + I_eta2 + n2) - 2 * ae * x23 - ae ^ 2 * x16;
    dx17 = x24;
    dx24 = Ae * ae * (c2 * S(x16 + x21)) - 2 * ae * x24 - ae ^ 2 * x17;
    dx18 = x25;
    dx25 = Ai * ai * (c3 * S(x19 - x20)) - 2 * ai * x25 - ai ^ 2 * x18;
    dx19 = x26;
    dx26 = Ae * ae * (cLi21 * S(x2 - x3 + x7) + c4 * S(x17 - x18 + x22) + I_eta2 + n2) - 2 * ae * x26 - ae ^ 2 * x19;
    dx20 = x27;
